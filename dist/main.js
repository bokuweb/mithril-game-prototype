...
},{"./app":3,"mithril":2}],2:[function(require,module,exports){
...
var SixTeen, SixTeenNotes, SixTeenViewModel, m,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

m = require('mithril');

SixTeenNotes = (function() {
  function SixTeenNotes(score) {
    return m.prop(score);
  }
...
SixTeen = (function() {
  function SixTeen() {
    this._view = bind(this._view, this);
    this._vm = new SixTeenViewModel();
    return {
      controller: (function(_this) {
        return function(score) {
          return _this._vm.init(score);
        };
      })(this),
      view: this._view
    };
    ...
    getNoteClass = (function(_this) {
      return function(note) {
        if (note.clearTime != null) {
          if (note.clearTime + 0.2 < _this._vm.time()) {
            return "note-delete";
          } else {
            return "note-hit";
          }
        }
        if (_this._vm.time() >= note.time + 0.6) {
          return "note-delete";
        }
        if (_this._vm.time() >= note.time + 0.4) {
          return "note-hide";
        }
        if (_this._vm.time() >= note.time - 0.2) {
          return "note-show";
        }
      };
    })(this);
